document.addEventListener('DOMContentLoaded', function(event) {
    const campoCNPJ = $('input[placeholder="CNPJ"]');
    const meuFone = $('input[name="personal_phone"]');
    const meuFoneVal = meuFone.val();    
    const campoUF =  $('select[name="uf"]'); 
    ...
    function identificaDDD(){
        let numeroFone = meuFone.val();
        let dddFone = numeroFone.substring(7, 5);
